        ...
        root.context.register_section({
            ...
            provider = function(player_name)
                return table.concat({
                    ...
                    "  if res and res.ok == false then return {done=false, continue=true, message=res.message or 'worldedit_agent failed'} end",
                    "  return {done=true, message=res and res.message or 'Done'}",
                    "",
