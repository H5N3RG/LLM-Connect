-- ===========================================================================
--  smart_lua_ide/code_executor.lua — legacy shim
--
--  v1.1.0-dev: the real execution backend lives at /core_executor.lua.
...
if not ex then
    local path = core.get_modpath("llm_connect") .. "/core_executor.lua"
